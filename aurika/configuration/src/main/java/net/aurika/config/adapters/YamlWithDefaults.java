...
import net.aurika.util.snakeyaml.common.SimpleWriter;
import net.aurika.util.snakeyaml.validation.CustomNodeValidators;
import net.aurika.util.snakeyaml.validation.NodeValidator;
import net.aurika.util.snakeyaml.validation.ValidationFailure;
