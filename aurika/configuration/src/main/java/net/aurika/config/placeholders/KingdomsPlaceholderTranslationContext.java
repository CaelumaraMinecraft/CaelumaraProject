...
public class KingdomsPlaceholderTranslationContext {
    @NotNull
    private final BasePlaceholderTargetProvider a;
    @NotNull
    private final KingdomsPlaceholder b;

    public KingdomsPlaceholderTranslationContext(@NotNull BasePlaceholderTargetProvider var1, @NotNull KingdomsPlaceholder var2) {
    ...
    @NotNull
    public final MessagePlaceholderProvider asMessageBuilder() {
        if (this.a instanceof MessagePlaceholderProvider) {
            return (MessagePlaceholderProvider)this.a;
        } else {
            MessagePlaceholderProvider var10000 = (MessagePlaceholderProvider) (new MessagePlaceholderProvider()).inheritContext(this.a, true);
    ...
    public final AuspicePlayer getPlayer() {
        Object var1;
        AuspicePlayer var10000 = (var1 = this.a.getPrimaryTarget()) instanceof AuspicePlayer ? (AuspicePlayer) var1 : null;
        if (var10000 == null) {
            OfflinePlayer var2 = (var1 = this.a.getPrimaryTarget()) instanceof OfflinePlayer ? (OfflinePlayer)var1 : null;
            if (var2 != null) {
