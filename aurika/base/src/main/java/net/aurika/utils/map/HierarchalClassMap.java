...
public class HierarchalClassMap<V> implements Map<Class<?>, V> {
    ...
    private final @NotNull Map<Class<?>, Optional<V>> original;
    private final @NotNull HierarchalClassMap<V>.HierarchyWalker hierarchyWalker;
