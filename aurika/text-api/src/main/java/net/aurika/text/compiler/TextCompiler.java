...
import net.aurika.text.MessageHandler;
...
import net.aurika.text.compiler.placeholders.TokenCursor;
import net.aurika.text.compiler.placeholders.types.LanguagePathPlaceholder;
import net.aurika.text.compiler.placeholders.types.MacroPlaceholder;
