package net.aurika.text;

import net.aurika.text.compiler.ColorAccessor;
...
public class TextObject implements MessageObjectBuilder {
    ...
    public void build(ComplexTextBuilderContextProvider provider) {
        MessagePlaceholderProvider var2 = provider.getSettings();
        TextPiece[] var3;
        int var4;
        TextPiece var6;
        if (this.b(var2)) {
    ...
    private static TextObject a(MessagePlaceholderProvider provider) {
        return AuspiceLang.PREFIX.getMessageObject(provider.getLanguage());
    }

    private boolean b(MessagePlaceholderProvider var1) {
