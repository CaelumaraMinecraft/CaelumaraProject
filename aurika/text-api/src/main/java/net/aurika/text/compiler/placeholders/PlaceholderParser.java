...
import net.aurika.text.compiler.placeholders.PlaceholderLexer.CharTokenType;
import net.aurika.text.compiler.placeholders.functions.PlaceholderFunctionData;
import net.aurika.text.compiler.placeholders.functions.PlaceholderFunctionParameters;
import net.aurika.text.compiler.placeholders.functions.PlaceholderNamedFunctionParameters;
import net.aurika.text.compiler.placeholders.functions.PlaceholderPositionalFunctionParameters;
import net.aurika.text.compiler.placeholders.modifiers.PlaceholderModifier;
import net.aurika.text.compiler.placeholders.types.ExternalOrLocalPlaceholder;
import net.aurika.text.compiler.placeholders.types.KingdomsPlaceholder;
import net.aurika.text.compiler.placeholders.types.PermissionPlaceholder;
import net.aurika.text.messenger.Messenger;
import net.aurika.text.placeholders.FunctionalPlaceholder;
