...
public class ComplexTextBuilderContextProvider extends TextBuilderContextProvider {
    ...
    public ComplexTextBuilderContextProvider(MessagePlaceholderProvider settings) {
        this(null, settings);
    }

    public ComplexTextBuilderContextProvider(ComplexTextBuilderContextProvider parent, MessagePlaceholderProvider settings) {
        this(parent, Component.text(), settings);
    }

    public ComplexTextBuilderContextProvider(ComplexTextBuilderContextProvider parent, TextComponent.Builder currentBuilder, MessagePlaceholderProvider settings) {
        super(settings);
        this.parent = parent;
