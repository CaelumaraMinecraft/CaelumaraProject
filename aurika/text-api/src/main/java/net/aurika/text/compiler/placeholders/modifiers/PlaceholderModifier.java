...
public interface PlaceholderModifier {
    ...
    @NotNull
    Object apply(@NotNull Placeholder placeholder, @Nullable Object object);
    ...
    @NotNull
    default Compatibility compareCompatibilityWith(@NotNull PlaceholderModifier other) {
    ...
    @NotNull
    static Map<String, PlaceholderModifier> getRegistered() {
