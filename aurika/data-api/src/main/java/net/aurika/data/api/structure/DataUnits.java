...
@Immutable
public class DataUnits implements Iterable<SimpleMappingDataEntry> {   // TODO rename
    private final @NonNull Set<SimpleMappingDataEntry> data;

    public static @NotNull DataUnits of(@NotNull LinkedHashSet<SimpleMappingDataEntry> data) {
        return new DataUnits(data);
    }

    public static @NotNull DataUnits of(@NotNull SimpleMappingDataEntry @NotNull ... data) {
        return new DataUnits(Set.of(data));
    }

    protected DataUnits(@NonNull Set<SimpleMappingDataEntry> data) {
...
//    }
    ...
    protected class EntryIterator implements Iterator<SimpleMappingDataEntry> {
        private final Iterator<SimpleMappingDataEntry> coreIterator = DataUnits.this.data.iterator();
