...
public interface NumberMatcher {
    ...
    final class Exact implements NumberMatcher {
        ...
        public Exact(@NotNull AnyNumber number) {
            Checker.Arg.notNull(number, "number");
            this.number = number;
        }
    ...
    final class LessThan implements NumberMatcher {
        ...
        public LessThan(@NotNull AnyNumber lessThan) {
            Checker.Arg.notNull(lessThan, "lessThan");
    ...
    final class GreaterThan implements NumberMatcher {
        ...
        public GreaterThan(@NotNull AnyNumber greaterThan) {
            Checker.Arg.notNull(greaterThan, "greaterThan");
    ...
    final class Parser {
        ...
        public @NotNull NumberMatcher parse() {
            ...
            if (symbol != null) {
                ...
                if (number != null) {
                    if (chars[i] == ',') {
                        return new Multiple(Strings.split(this.value, ',', true).stream().map(AnyNumber::of).toArray(AnyNumber[]::new));
                    } else {
                            ...
                            if (x != 'x') {
                                ...
                                if (secSymb == null) {
                                    ...
                                    if (secNum == null) {
                                        ...
                                        return new Range(this.symbolToMatcher(firstSym, number, NumberMatcher.Parser.Side.LEFT_HAND), this.symbolToMatcher(secSymb, secNum, NumberMatcher.Parser.Side.RIGHT_HAND));
                                    }
                                }
                            }
                        }
        ...
        private @Nullable String checkSymbol() {
            if (i >= len)
                throw new IllegalArgumentException("Expected a number comparison symbol at " + i + " but reached the end in " + value);
