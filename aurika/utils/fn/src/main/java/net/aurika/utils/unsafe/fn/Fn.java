package net.aurika.utils.unsafe.fn;
...
public final class Fn {
    ...
    @SuppressWarnings("unchecked")
    public static <T> @Nullable T safeCast(@NotNull Object object, @NotNull Class<T> clazz) {
    ...
    public static <T> @NotNull ChainedCallable<T> take(Callable<T> supplier) {
    ...
    public static final class ChainedCallable<R> {
        ...
        public @NotNull ChainedCallable<R> or(Callable<R> other) {
            if (!hasResult) {
                handle = other;
                checkResult();
            }
        ...
        public @NotNull ChainedCallable<R> or(@Nullable R other) {
        ...
        public @NotNull R orElse(R finalCheck) {
