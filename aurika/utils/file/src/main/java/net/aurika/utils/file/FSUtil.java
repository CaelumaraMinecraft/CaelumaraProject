package net.aurika.utils.file;

import net.aurika.utils.array.ArrayUtils;
...
public final class FSUtil {
    ...
    public static void deleteFolder(@NotNull Path folder, @NotNull Predicate<Path> ignore) {
    ...
    public static List<Path> getFiles(Path folder) {
        ...
        PathIterator iterator = new PathIterator(
                null,
                (p, attrs) -> {
                    if (attrs.isRegularFile()) files.add(p);
                }
        );
        try {
