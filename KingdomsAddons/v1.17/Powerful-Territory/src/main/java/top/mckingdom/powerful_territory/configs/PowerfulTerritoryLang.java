...
public enum PowerfulTerritoryLang implements DefinedMessenger {
    ...
    COMMAND_ADMIN_DOMAIN_CATEGORY_GET_FAILED_NOT_CLAIMED("{$e}The land is not claimed, it don't have category.", 1, 2, 3, 4, 5, 6),
    ...
    COMMAND_ADMIN_DOMAIN_CONTRACTION_GET_FAILED_NOT_CLAIMED("{$e}The land is not claimed, it don't have contractions.", 1, 2, 3, 4, 5, 6),
    ...
    COMMAND_DOMAIN_CATEGORY_GET_SUCCESS("{$p}The land category of land {$s}%location% {$p}is {$s}%category%.", 1, 2, 3, 4),
    COMMAND_DOMAIN_CATEGORY_GET_FAILED_OTHER_KINGDOM("{$e}You can't see the category of other kingdom's land.", 1, 2, 3, 4, 5),
    ...
    COMMAND_DOMAIN_CONTRACTION_GET_FAILED_OTHER_KINGDOM("{$e}You can not see the contractions in other kingdom's land!", 1, 2, 3, 4, 5),
    ...
    COMMAND_DOMAIN_CONTRACTION_ALLOCATE_SUCCESS("{$p}Successfully allocated the player {$s}%player% {$p}a {$s}%duration% {$s}%contraction% {$p}contracting project", 1, 2, 3, 4),
    COMMAND_DOMAIN_CONTRACTION_ALLOCATE_FAILED_ALREADY_SET("{$e}Already allocation contraction {$p}%contraction% {$e}for player {$p}%player%{$e}!", 1, 2, 3, 4),
    COMMAND_DOMAIN_CONTRACTION_ALLOCATE_FAILED_OTHER_KINGDOM("{$e}You can not allocation contractions for other kingdom's land!", 1, 2, 3, 4),
    COMMAND_DOMAIN_CONTRACTION_ALLOCATE_FAILED_NOT_CLAIMED("{$e}This land isn't claimed!", 1, 2, 3, 4),
    COMMAND_DOMAIN_CONTRACTION_ALLOCATE_FAILED_NO_PERMISSION("{$e}You don't have permission or contraction to allocate.", 1, 2, 3, 4),

    COMMAND_DOMAIN_CONTRACTION_DEALLOCATE_NAME("deallocate", 1, 2, 3, 4),
    COMMAND_DOMAIN_CONTRACTION_DEALLOCATE_USAGE("{$usage}land contraction deallocate <contraction> <receiver> [allocator]", 1, 2, 3, 4),
    ...
    COMMAND_DOMAIN_CONTRACTION_DEALLOCATE_SUCCESS_SINGLE_ALLOCATOR("{$p}Successful deallocate land contraction %contraction% for player %receiver% for allocator %allocator% in land %location%", 1, 2, 3, 4, 5),
    COMMAND_DOMAIN_CONTRACTION_DEALLOCATE_SUCCESS_ALL_ALLOCATOR("{$p}Successful deallocate land contraction %contraction% for player %receiver% in land %location%", 1, 2, 3, 4, 5),
    COMMAND_DOMAIN_CONTRACTION_DEALLOCATE_FAILED_NOT_CLAIMED("{$e}The land is not claimed, you can't deallocate contractions of this land.", 1, 2, 3, 4, 5),
    ...
    COMMAND_ADMIN_DOMAIN_INVADEPROTECTION_DESCRIPTION("{$s}Change the state so that the land is no longer invaded", 1, 2, 3, 4),
    ...
    COMMAND_ADMIN_DOMAIN_INVADEPROTECTION_SET_SUCCESS("{$p}Success to set the invade protection stat of the land: {$s}%new-status%", 1, 2, 3, 4, 5),
    COMMAND_ADMIN_DOMAIN_INVADEPROTECTION_SET_FAILED_NOT_CLAIMED("{$e}This land isn't claimed!", 1, 2, 3, 4, 5, 6),
    COMMAND_ADMIN_DOMAIN_INVADEPROTECTION_SET_FAILED_UNKNOWN_STATUS("{$e}Unknown invade protection status.", 1, 2, 3, 4, 5, 6),

    COMMAND_ADMIN_DOMAIN_INVADEPROTECTION_GET_USAGES("{$usage} admin land invade-protection get [x] [z]", 1, 2, 3, 4, 5),
    COMMAND_ADMIN_DOMAIN_INVADEPROTECTION_GET_DESCRIPTION("{$s}See the invade protection stat of the land", 1, 2, 3, 4, 5),
    COMMAND_ADMIN_DOMAIN_INVADEPROTECTION_GET_SUCCESS("{$p}Invade protection status of this land is: {$sp}%status%", 1, 2, 3, 4, 5),
