...
public class CommandAdminLandInvadeProtectionGet extends KingdomsCommand {
    ...
    public @NotNull CommandResult execute(@NonNull CommandContext context) {
        ...
        PowerfulTerritoryLang.COMMAND_ADMIN_DOMAIN_INVADEPROTECTION_GET_SUCCESS.sendMessage(player, "status", InvadeProtections.getInvadeProtection(land).getName(language));
