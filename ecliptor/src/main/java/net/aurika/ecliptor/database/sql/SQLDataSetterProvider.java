...
public class SQLDataSetterProvider extends SQLDataProvider implements SectionableDataSetter {
  ...
  private void a() {
    if (this.getName$core() != null && !this.getNameIsSection$core()) {
      throw new IllegalStateException(
          "Specified name is not given a type: " + this.getTable$core() + " -> " + this.getName$core());
    }
  }
  ...
  public @NotNull SectionableDataSetter get(@NotNull String key) {
    ...
    this.a();
    return new SQLDataSetterProvider(
        this.getDatabaseType$core(), this.getTable$core(), this.nameSepOrEmpty$core() + key,
        this.isInsideSingularEntity$core(), false, this.a
    );
  }
  ...
  public @NotNull SectionableDataSetter createSection(@NotNull String key) {
    ...
    return new SQLDataSetterProvider(
        this.getDatabaseType$core(), this.getTable$core(), this.nameSepOrEmpty$core() + key,
        this.isInsideSingularEntity$core(), true, this.a
    );
  }
