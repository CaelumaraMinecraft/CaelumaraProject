  ...
  public static @NotNull DatabaseProperties defaults(@NotNull DatabaseType databaseType) {  // TODO 迁移
    ...
    if (DatabaseProperties.i) {
      ...
      label28:
      {
        ...
        var2.verifyServerCertificate(
            AuspiceGlobalConfig.DATABASE_SSL_VERIFY_SERVER_CERTIFICATE.getManager().getBoolean(new String[0]));
        var2.allowPublicKeyRetrieval(
            AuspiceGlobalConfig.DATABASE_SSL_ALLOW_PUBLIC_KEY_RETRIEVAL.getManager().getBoolean(new String[0]));
