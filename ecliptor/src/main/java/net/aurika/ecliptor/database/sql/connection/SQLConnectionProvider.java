...
public abstract class SQLConnectionProvider implements Closeable {
  ...
  public final void testTemporaryLibCreation$core(@NotNull DatabaseType databaseType) {
    ...
    if (ArraysKt.contains(
        var2, databaseType) && (!var3.exists() || !var3.isDirectory() || !var3.canRead() || !var3.canWrite())) {
      AuspiceLogger.error(
          "A problem has occurred for with java.io.tmpdir " + var3.exists() + " | " + var3.isDirectory() + " | " + var3.canRead() + " | " + var3.canWrite());
    }
  }
