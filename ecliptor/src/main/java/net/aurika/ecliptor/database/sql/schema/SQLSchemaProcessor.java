      ...
      try {
        ...
        try {
          ...
          for (String var5 : var11) {
            ...
            var5 = Strings.replace(
                var5, "{PREFIX}", ((String) AuspiceGlobalConfig.DATABASE_TABLE_PREFIX.getString() + '_'));
            ...
            var5 = Strings.replace(
                Strings.replace(
                    Strings.replace(
                        Strings.replace(a(CHUNK_LOCATION, var5, "world WORLD", "x INT", "z INT"), "WORLD", "VARCHAR(64)"),
                        "RANK_NODE", "VARCHAR(50)"
