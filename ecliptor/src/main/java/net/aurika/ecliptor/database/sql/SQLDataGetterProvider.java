...
public class SQLDataGetterProvider extends SQLDataProvider implements SectionableDataGetter {
  ...
  public SQLDataGetterProvider(@NotNull DatabaseType var1, @NotNull String var2, @Nullable String var3, boolean var4, boolean var5, @NotNull SimpleResultSetQuery var6) {
    ...
    Validate.Arg.notNull(var6, "");
    this.a = var6;
  }

  @Override
  public @NotNull SectionableDataGetter asSection() {
    return new SQLDataGetterProvider(
        this.getDatabaseType$core(), this.getTable$core(), this.getName$core(), false, true, this.a);
  }
  ...
  public @NotNull SectionableDataGetter get(@NotNull String key) {
    ...
    if (this.getName$core() != null && !this.getNameIsSection$core()) {
      throw new IllegalStateException(
          "Attempting to get() without specifying the previous ones type: " + this.getTable$core() + " -> " + this.getName$core() + " -> " + key);
    } else {
      return new SQLDataGetterProvider(
          this.getDatabaseType$core(), this.getTable$core(), this.nameSepOrEmpty$core() + key, false, false, this.a);
    }
  }
  ...
  public @Nullable SimpleLocation asLocation() {
    ...
    if (worldName == null) {
      ...
      return new SimpleLocation(
          worldName, var1.getDouble("x"), var1.getDouble("y"), var1.getDouble("z"), var1.getFloat("yaw"),
          var1.getFloat("pitch")
      );
    }
  }
  ...
  public <V, C extends Collection<V>> C asCollection(@NotNull C c, @NotNull BiConsumer<C, SectionableDataGetter> handler) {
    Validate.Arg.notNull(c, "");
    Validate.Arg.notNull(handler, "");
    String var10000 = null;
    try {
      var10000 = this.a.getString(this.getNamed$core());
    } catch (SQLException e) {
    ...
    if (var10000 != null) {
      ...
      for (JsonElement var4 : jsonArray) {
        ...
        handler.accept(c, new JsonElementDataProvider(var4));
      }
    }
    return c;
  }
  ...
  public <K, V, M extends Map<K, V>> @NotNull M asMap(@NotNull M m, @NotNull TriConsumer<M, DataGetter, SectionableDataGetter> dataProcessor) {
    Validate.Arg.notNull(m, "");
    Validate.Arg.notNull(dataProcessor, "");
    String var10000 = null;
    try {
      var10000 = this.a.getString(this.getNamed$core());
    } catch (SQLException e) {
