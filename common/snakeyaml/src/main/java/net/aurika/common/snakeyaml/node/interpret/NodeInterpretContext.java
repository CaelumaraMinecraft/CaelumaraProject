...
import static net.aurika.common.snakeyaml.node.interpret.NodeInterpretContext.Result.NULL;
...
public class NodeInterpretContext<V> {
  ...
  public @Nullable V asResult(@NotNull Result result, @Nullable V value) {
    Validate.Arg.notNull(result, "result");
    this.result = result;
    if (value == null) {
      value = defaultValue;
    }
  ...
  public static <T> @NotNull NodeInterpretContext<T> nullable() {
    return new NodeInterpretContext<>(null, () -> null, () -> null);
  }
