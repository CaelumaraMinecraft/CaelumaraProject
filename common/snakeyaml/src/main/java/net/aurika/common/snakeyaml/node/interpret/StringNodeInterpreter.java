...
import static net.aurika.common.snakeyaml.node.interpret.NodeInterpretContext.Result.DIFFERENT_TYPE;
import static net.aurika.common.snakeyaml.node.interpret.NodeInterpretContext.Result.SUCCESS;
...
public class StringNodeInterpreter extends AbstractNodeInterpreter<String> implements NodeInterpreter<String> {
  ...
  public static final @Unmodifiable Set<ScalarStyle> NO_PLAIN_STYLES = Set.of(
      DOUBLE_QUOTED, SINGLE_QUOTED, LITERAL, FOLDED, JSON_SCALAR_STYLE);
