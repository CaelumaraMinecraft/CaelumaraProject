...
import static net.aurika.common.key.Path.checkPathArrayProblem;
import static net.aurika.common.key.Path.checkPathStringProblem;

public interface Group extends PathAware, GroupAware {
