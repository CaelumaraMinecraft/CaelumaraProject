...
public class NBTTagType<T extends NBTTag> {
    ...
    public static final NBTTagType<NBTTagEnd> END = new NBTTagType<>(NBTTagId.END, BinaryTagTypes.END, NBTTagEnd.class, (it) -> NBTTagEnd.nbtTagEnd());
    public static final NBTTagType<NBTTagByte> BYTE = new NBTTagType<>(NBTTagId.BYTE, BinaryTagTypes.BYTE, NBTTagByte.class, (it) -> NBTTagByte.nbtTagByte((Byte) it));
    public static final NBTTagType<NBTTagShort> SHORT = new NBTTagType<>(NBTTagId.SHORT, BinaryTagTypes.SHORT, NBTTagShort.class, (it) -> NBTTagShort.nbtTagShort((Short) it));
    public static final NBTTagType<NBTTagInt> INT = new NBTTagType<>(NBTTagId.INT, BinaryTagTypes.INT, NBTTagInt.class, (it) -> NBTTagInt.nbtTagInt((Integer) it));
    public static final NBTTagType<NBTTagLong> LONG = new NBTTagType<>(NBTTagId.LONG, BinaryTagTypes.LONG, NBTTagLong.class, (it) -> NBTTagLong.nbtTagLong((Long) it));
    public static final NBTTagType<NBTTagFloat> FLOAT = new NBTTagType<>(NBTTagId.FLOAT, BinaryTagTypes.FLOAT, NBTTagFloat.class, (it) -> NBTTagFloat.nbtTagFloat((Float) it));
    public static final NBTTagType<NBTTagDouble> DOUBLE = new NBTTagType<>(NBTTagId.DOUBLE, BinaryTagTypes.DOUBLE, NBTTagDouble.class, (it) -> NBTTagDouble.nbtTagDouble((Double) it));
    public static final NBTTagType<NBTTagByteArray> BYTE_ARRAY = new NBTTagType<>(NBTTagId.BYTE_ARRAY, BinaryTagTypes.BYTE_ARRAY, NBTTagByteArray.class, (it) -> NBTTagByteArray.nbtTagByteArrayRaw(Arrays.copyOf((byte[]) it, ((byte[]) it).length)));
    public static final NBTTagType<NBTTagString> STRING = new NBTTagType<>(NBTTagId.STRING, BinaryTagTypes.STRING, NBTTagString.class, (it) -> NBTTagString.nbtTagString((String) it));
    public static final NBTTagType<NBTTagList<?>> LIST = Fn.cast(new NBTTagType<>(NBTTagId.LIST, BinaryTagTypes.LIST, NBTTagList.class, (it) -> NBTTagList.ofUnknown((List) it)));
    public static final NBTTagType<NBTTagCompound> COMPOUND = new NBTTagType<>(NBTTagId.COMPOUND, BinaryTagTypes.COMPOUND, NBTTagCompound.class, (it) -> NBTTagCompound.nbtTagCompound(castAs(it)));
    public static final NBTTagType<NBTTagIntArray> INT_ARRAY = new NBTTagType<>(NBTTagId.INT_ARRAY, BinaryTagTypes.INT_ARRAY, NBTTagIntArray.class, (it) -> NBTTagIntArray.nbtTagIntArrayRaw(Arrays.copyOf((int[]) it, ((int[]) it).length)));
    public static final NBTTagType<NBTTagLongArray> LONG_ARRAY = new NBTTagType<>(NBTTagId.LONG_ARRAY, BinaryTagTypes.LONG_ARRAY, NBTTagLongArray.class, (it) -> NBTTagLongArray.nbtTagLongArray(Arrays.copyOf((long[]) it, ((long[]) it).length)));
