    ...
    static @NotNull NBTTagList<?> ofUnknown(@NotNull List<? extends NBTTag> value) {
        ...
        for (NBTTag t : value) {
            if (elementType == null) {
                ...
                throw new IllegalArgumentException("Element is not of type " + elementType.name() + " but " + t.nbtTagType().name());
            }
        }
            ...
            for (NBTTag t : value) {
                if (elementType == null) {
                    ...
                    if (elementType != t.nbtTagType()) {
                        throw new IllegalArgumentException("Element is not of type " + elementType + " but " + t.nbtTagType().name());
                    }
                }
            }
        }
    ...
    public void add(@NotNull E elementTag) throws IllegalArgumentException {
        if (this.elementType != null) {
            if (elementTag.nbtTagType() != this.elementType) {
                throw new IllegalArgumentException("Element is not of type " + this.elementType.name() + " but " + elementTag.nbtTagType().name());
            }
        } else {
