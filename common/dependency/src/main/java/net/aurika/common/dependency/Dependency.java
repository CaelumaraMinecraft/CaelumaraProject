...
public enum Dependency {
  ...
  String getMavenRepoPath() {
    ...
    return String.format(
        MAVEN_FORMAT, this.groupId.replace(".", "/"), this.artifactId, version, this.artifactId, version);
  }

  public DependencyVersion getDefaultVersion() {
    return Objects.requireNonNull(
        this.versions.get(this.defaultVersion),
        () -> "Cannot find default version " + this.defaultVersion + " for " + this
    );
  }
