package net.aurika.util.file.walker;

import net.aurika.util.file.walker.visitors.PathVisit;
import net.aurika.util.file.walker.visitors.PathVisit.Type;
import net.aurika.util.file.walker.visitors.PathVisitor;
