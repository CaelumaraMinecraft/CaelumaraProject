...
public final class FastUUID {
  ...
  public static @NotNull UUID randomUUID(@NotNull Random random) {
  ...
  public static @NotNull UUID bytesToUUID(byte[] data) {
    long msb = 0L;
    long lsb = 0L;
  ...
  public static @NotNull UUID fromString(@NotNull CharSequence uuid) {
    try {
      long mostSignificantBits = getHexValueForChar(uuid.charAt(0)) << 60 | getHexValueForChar(
          uuid.charAt(1)) << 56 | getHexValueForChar(uuid.charAt(2)) << 52 | getHexValueForChar(
          uuid.charAt(3)) << 48 | getHexValueForChar(uuid.charAt(4)) << 44 | getHexValueForChar(
          uuid.charAt(5)) << 40 | getHexValueForChar(uuid.charAt(6)) << 36 | getHexValueForChar(
          uuid.charAt(7)) << 32 | getHexValueForChar(uuid.charAt(9)) << 28 | getHexValueForChar(
          uuid.charAt(10)) << 24 | getHexValueForChar(uuid.charAt(11)) << 20 | getHexValueForChar(
          uuid.charAt(12)) << 16 | getHexValueForChar(uuid.charAt(14)) << 12 | getHexValueForChar(
          uuid.charAt(15)) << 8 | getHexValueForChar(uuid.charAt(16)) << 4 | getHexValueForChar(uuid.charAt(17));
      long leastSignificantBits = getHexValueForChar(uuid.charAt(19)) << 60 | getHexValueForChar(
          uuid.charAt(20)) << 56 | getHexValueForChar(uuid.charAt(21)) << 52 | getHexValueForChar(
          uuid.charAt(22)) << 48 | getHexValueForChar(uuid.charAt(24)) << 44 | getHexValueForChar(
          uuid.charAt(25)) << 40 | getHexValueForChar(uuid.charAt(26)) << 36 | getHexValueForChar(
          uuid.charAt(27)) << 32 | getHexValueForChar(uuid.charAt(28)) << 28 | getHexValueForChar(
          uuid.charAt(29)) << 24 | getHexValueForChar(uuid.charAt(30)) << 20 | getHexValueForChar(
          uuid.charAt(31)) << 16 | getHexValueForChar(uuid.charAt(32)) << 12 | getHexValueForChar(
          uuid.charAt(33)) << 8 | getHexValueForChar(uuid.charAt(34)) << 4 | getHexValueForChar(uuid.charAt(35));
