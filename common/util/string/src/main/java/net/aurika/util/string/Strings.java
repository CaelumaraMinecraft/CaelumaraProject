...
public final class Strings {
  ...
  public static String random(int var0, int var1, String var2) {
    ...
    char[] var4;
    for (var4 = new char[(var0 = (var3 = ThreadLocalRandom.current()).nextInt(var0, var1 + 1)) <= 0 ? var3.nextInt(
        Math.abs(var0)) : var0]; var0-- > 0; var4[var0] = var2.charAt(var3.nextInt(var2.length()))) {
    }
  ...
  public static String findSimilar(String var01, Collection<String> var1) {
    ...
    return var1.stream().filter((var1x) -> var0.equals(var1x.toLowerCase())).findFirst().orElseGet(
        () -> var1.stream().filter((var1x) -> {
