...
import static net.aurika.util.snakeyaml.nodes.interpret.NodeInterpretContext.Result.DIFFERENT_TYPE;
import static net.aurika.util.snakeyaml.nodes.interpret.NodeInterpretContext.Result.SUCCESS;
