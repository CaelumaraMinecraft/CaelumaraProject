...
public final class BaseColorUtils {
    ...
    protected static final byte[] CHAR_CODE_MAP;
    ...
    public static CodedChatFormats hexColorToStd(Color color) {
        switch (BaseColorUtils.getRGB(color)) {
            case 0x00_00_00 -> {
                return CodedChatFormats.BLACK;
            }
            case 0xFF_FF_FF -> {
                return CodedChatFormats.WHITE;
            }
            case 0x00_00_AA -> {
                return CodedChatFormats.DARK_BLUE;
            }
            case 0x00_AA_00 -> {
                return CodedChatFormats.DARK_GREEN;
            }
            case 0x00_AA_AA -> {
                return CodedChatFormats.DARK_AQUA;
            }
            case 0xAA_00_00 -> {
                return CodedChatFormats.DARK_RED;
            }
            case 0xAA_00_AA -> {
                return CodedChatFormats.DARK_PURPLE;
            }
            case 0x55_55_55 -> {
                return CodedChatFormats.DARK_GRAY;
            }
            case 0xAA_AA_AA -> {
                return CodedChatFormats.GRAY;
            }
            case 0xFF_AA_00 -> {
                return CodedChatFormats.GOLD;
            }
            case 0x55_55_FF -> {
                return CodedChatFormats.BLUE;
            }
            case 0x55_FF_55 -> {
                return CodedChatFormats.GREEN;
            }
            case 0x55_FF_FF -> {
                return CodedChatFormats.AQUA;
            }
            case 0xFF_55_55 -> {
                return CodedChatFormats.RED;
            }
            case 0xFF_55_FF -> {
                return CodedChatFormats.LIGHT_PURPLE;
            }
            case 0xFF_FF_55 -> {
                return CodedChatFormats.YELLOW;
            }
        }
