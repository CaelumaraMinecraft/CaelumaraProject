...
public class LanguageEntryMessenger implements Messenger {
    ...
    public final @NotNull DefaultedMessenger safe() {
        return this.or(() -> {
            StringBuilder var10002 = new StringBuilder("&8[&4Error&8] &eMessage path not defined even for EN language &quantum");
            String[] var10003 = this.path.getPath();
            Intrinsics.checkNotNullExpressionValue(var10003, "");
            return new StaticMessenger(var10002.append(ArraysKt.joinToString((Object[]) var10003, " &7-> &quantum", "", "", -1, "", null)).toString());
        });
    }
