...
import top.auspice.nbt.stream.exception.NBTWriteException;
import top.auspice.nbt.stream.impl.NBTReader;
...
public class NBTBinaryIO {

    private NBTBinaryIO() {
    }

    @NotNull
    public static NBTStream read(@NotNull DataInput input) {
