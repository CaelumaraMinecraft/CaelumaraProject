...
public class StdIdDataType {
    ...
    public static class NoKey extends IdDataTypeHandler<String> {
        ...
        @NotNull
        public String fromString(@NotNull String var1) {
            throw new UnsupportedOperationException();
        }
    ...
    public static class UUIDKey extends IdDataTypeHandler<UUID> {
        ...
        @NotNull
        public UUID fromString(@NotNull String var1) {
            Objects.requireNonNull(var1, "");
            UUID var10000 = FastUUID.fromString(var1);
    ...
    public static class SimpleChunkLocationKey extends IdDataTypeHandler<SimpleChunkLocation> {
        ...
        public SimpleChunkLocation fromSQL(@NotNull SimpleResultSetQuery var1) throws SQLException {
            Objects.requireNonNull(var1);
            return new SimpleChunkLocation(var1.getString(this.getPrefix$core() + "_world"), var1.getInt(this.getPrefix$core() + "_x"), var1.getInt(this.getPrefix$core() + "_z"));
        }

        @NotNull
        public SimpleChunkLocation fromString(@NotNull String var1) {
            Objects.requireNonNull(var1);
            SimpleChunkLocation var10000 = SimpleChunkLocation.fromString(var1);
            Intrinsics.checkNotNullExpressionValue(var10000, "");
            return var10000;
        }
