...
public class SingularMongoDBDatabase<T extends DataObject.Impl> extends MongoDBDatabase<T> implements SingularDatabase<T> {
    ...
    public static <T extends DataObject.Impl> @NotNull SingularMongoDBDatabase<T> withCollection(@NotNull String var1, @NotNull SingularDataHandler<T> var2) {
