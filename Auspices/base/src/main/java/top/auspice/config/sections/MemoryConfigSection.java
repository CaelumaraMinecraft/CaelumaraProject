...
import top.auspice.config.sections.label.StandardLabelResolver;
import top.auspice.config.sections.format.ConfigSectionFormat;
import top.auspice.config.sections.format.StandardConfigSectionFormat;
