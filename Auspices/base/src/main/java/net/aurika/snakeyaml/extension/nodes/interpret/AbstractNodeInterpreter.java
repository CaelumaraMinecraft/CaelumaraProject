...
import static net.aurika.snakeyaml.extension.nodes.interpret.NodeInterpretContext.Result.NULL;

public abstract class AbstractNodeInterpreter<T> implements NodeInterpreter<T> {
