package net.aurika.data.database.sql.statements.setters;
...
import net.aurika.data.database.sql.base.SQLDatabase;
import net.aurika.data.database.sql.statements.SQLUpsert;
...
public class PreparedNamedSetterStatement implements SimplePreparedStatement {
    ...
    public void buildStatement(@NotNull String var1, @NotNull Connection var2) {
        ...
        if (!this.c) {
            ...
            for (net.aurika.data.database.sql.statements.setters.a value : this.b) {
    ...
    public void execute() {
        ...
        AutoCloseableUtils.closeFinally(var1, null);
    }
    ...
    public void setJson(@NotNull String var1, @Nullable JsonElement var2) {
        Intrinsics.checkNotNullParameter(var1, "");
        switch (this.a) {
            case H2:
                this.a(var1, i -> {
                    ...
                    byte[] var9;
                    if (var2 != null) {
                        String var6 = KingdomsGson.toString(var2);
