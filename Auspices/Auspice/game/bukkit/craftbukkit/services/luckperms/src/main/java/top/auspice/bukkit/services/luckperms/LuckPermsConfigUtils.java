package top.auspice.bukkit.services.luckperms;
...
public class LuckPermsConfigUtils {
    ...
    public void addAllPermissions(@NotNull Collection<UUID> var1, @NotNull ConfigSection var2, int var3) {
        ...
        while(true) {
            ...
            } while(!Intrinsics.areEqual(var4.next(), "permissions"));

            Node var10000 = var2.getNode("permissions");
    ...
    public void removeAllPermissions(@NotNull Collection<UUID> var1, @NotNull ConfigSection var2) {
        ...
        while(true) {
            while(var4.hasNext()) {
                ...
                if (Intrinsics.areEqual(var5, "permissions")) {
                    Intrinsics.checkNotNull(var6);
                    SequenceNode var9;
    ...
    public void performPermissionOperations(@NotNull Collection<UUID> var1, @NotNull ConfigSection var2, @Nullable ConfigSection var3, int var4, @NotNull LuckPermsConfigUtils.Operation var5, @NotNull MessagePlaceholderProvider var6) {
        ...
        KingdomsConfig.getClosestLevelSection((ConfigAccessor)(new YamlClearlyConfigAccessor(var2, var2)).noDefault(), var4);
        String[] var7;
        (var7 = new String[1])[0] = String.valueOf(var4);
        if ((var3 = var2.getSection(var7)).isSet("permissions")) {
                ...
                switch (var10000.hashCode()) {
                    case -934610812:
                        if (var9.equals("remove")) {
                            ...
                            ConditionChain.Companion.performPermissionOperations(var1, var2, (ConfigSection)null, var4 - 1, Operation.REMOVE, var6);
                        }
                }
            }

            LuckPermsConfigUtils.perform(var1, var5, var3.getNode("permissions"));
        }
        ...
        while(var10.hasNext()) {
            String var8;
            if (ConditionProcessor.process(ConditionCompiler.compile(var8 = (String)var10.next()).evaluate(), (PlaceholderProvider)var6)) {
                Node var11;
