package top.auspice.bukkit.server.adapers;
...
public final class BukkitAdapter {
    ...
    public static OldLocation adapt(@Nullable Location location) {
        ...
        if (location != null) {
            ...
            var10000 = new OldLocation(adapt(var10002), location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        } else {
            var10000 = null;
        }
    ...
    public static Location adapt(@Nullable OldLocation location) {
        Location var10000;
        if (location != null) {
            var10000 = new Location(adapt(location.getWorld()), location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        } else {
            var10000 = null;
        }
    ...
    public static BlockVector3 adaptVector(@NotNull Block block) {
        ...
        return BlockVector3.of($this$adaptVector_u24lambda_u244.getBlockX(), $this$adaptVector_u24lambda_u244.getBlockY(), $this$adaptVector_u24lambda_u244.getBlockZ());
    }
    ...
    public static BlockLocation3 adaptLocation(@NotNull Block block) {
        ...
        Objects.requireNonNull(var10001);
        return BlockLocation3.of(adapt(var10001), $this$adaptLocation_u24lambda_u245.getBlockX(), $this$adaptLocation_u24lambda_u245.getBlockY(), $this$adaptLocation_u24lambda_u245.getBlockZ());
    }
