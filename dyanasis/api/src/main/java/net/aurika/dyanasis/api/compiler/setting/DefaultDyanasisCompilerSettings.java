...
public class DefaultDyanasisCompilerSettings implements DyanasisCompilerSetting {

  public static final DefaultDyanasisCompilerSettings DEFAULT = DefaultDyanasisCompilerSettings.builder().build();

  public static DefaultDyanasisCompilerSettingsBuilder builder() {
    return new DefaultDyanasisCompilerSettingsBuilder();
  }
  ...
  public DefaultDyanasisCompilerSettings(@NotNull Idents idents) { this.idents = idents; }
  ...
  public class Idents {
    ...
    public @NotNull DefaultDyanasisCompilerSettings parentSettings() { return DefaultDyanasisCompilerSettings.this; }
  ...
  public class Lexers {
    ...
    public @NotNull DefaultDyanasisCompilerSettings parentSettings() {
      return DefaultDyanasisCompilerSettings.this;
    }
