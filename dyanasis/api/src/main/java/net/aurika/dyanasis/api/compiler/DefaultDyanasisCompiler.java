...
public class DefaultDyanasisCompiler extends AbstractDyanasisCompiler {
  ...
  public DefaultDyanasisCompiler(@NotNull DefaultDyanasisCompiler parent, @NotNull String original) {
    this(parent, original, 0, original.length());
  }

  public DefaultDyanasisCompiler(@NotNull DefaultDyanasisCompiler parent, @NotNull String original, int ap, int bp) {
    super(parent, original);
    this.ap = ap;
    this.bp = bp;
  }

  public DefaultDyanasisCompiler(@NotNull DyanasisCompilerSettings settings, @NotNull String original) {
    this(settings, original, 0, original.length());
  }

  public DefaultDyanasisCompiler(@NotNull DyanasisCompilerSettings settings, @NotNull String original, int ap, int bp) {
  ...
  public class InvokeFunctionExprImpl extends DefaultAccess implements InvokeFunctionStatement {
    ...
    public InvokeFunctionExprImpl(@NotNull DefaultDyanasisCompiler.DedfaultExpression invoked, @NotNull String functionName, @NotNull String argumentsRaw) {
      super(invoked);
  ...
  public class InvokePropertyExprImpl extends DefaultAccess implements InvokePropertyStatement {
    ...
    public InvokePropertyExprImpl(@NotNull DefaultDyanasisCompiler.DedfaultExpression invoked, @NotNull String propertyName) {
      super(invoked);
  ...
  public abstract class DefaultAccess extends DedfaultExpression implements Access {
    ...
    @Override
    public @NotNull DefaultDyanasisCompiler.DedfaultExpression invoked() {
      return invoked;
    }
  ...
  public abstract class DedfaultExpression implements Expression {
    ...
    @Override
    public @NotNull DefaultDyanasisCompiler compiler() { return DefaultDyanasisCompiler.this; }
  ...
  public class DefaultStatementLexer extends DefaultLexer implements StatementLexer {
    ...
    @Override
    public @NotNull DefaultDyanasisCompiler.DedfaultExpression lex() {
      skipWhitespaces();
      @Nullable DefaultDyanasisCompiler.DefaultStatementLexer.StandardInvokeExpr anonymousThisInvoke = lexAnonymousSelfInvoke();
    }
