...
public abstract class AbstractDyanasisObject<T, Lexer extends DyanasisCompiler, Doc extends DyanasisObject.ObjectDoc> implements DyanasisObject, DyanasisDocEditable<Doc> {
  ...
  protected AbstractDyanasisObject(
      @NotNull DyanasisRuntime runtime,
      T value,
      @NotNull Lexer lexer,
      @Nullable Doc doc
  ...
  public abstract static class AbstractObjectFunction extends AbstractDyanasisFunction implements ObjectFunction {
    ...
    public AbstractObjectFunction(@NotNull DyanasisFunctionSignature key) {
      super(key);
    }
