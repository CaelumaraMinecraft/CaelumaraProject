...
public abstract class AbstractDyanasisLexer implements DyanasisLexer {
    ...
    public AbstractDyanasisLexer(@Nullable DyanasisLexer parent, @NotNull DyanasisLexerSettings settings, @NotNull String original) {
