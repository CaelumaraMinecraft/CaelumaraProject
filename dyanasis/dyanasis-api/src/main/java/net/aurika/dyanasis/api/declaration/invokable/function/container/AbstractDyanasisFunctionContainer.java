...
public class AbstractDyanasisFunctionContainer implements DyanasisFunctionContainer {
    protected final @NotNull Map<DyanasisFunctionKey, DyanasisFunction> functions;

    protected AbstractDyanasisFunctionContainer() {
        this(new HashMap<>());
    }

    protected AbstractDyanasisFunctionContainer(@NotNull Map<DyanasisFunctionKey, DyanasisFunction> functions) {
