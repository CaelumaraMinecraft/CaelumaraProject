...
/**
 * Builder of {@linkplain DyanasisLexerSettings}.
 * Note:
 */
public class DyanasisLexerSettingsBuilder implements Cloneable {
    ...
    public DyanasisLexerSettingsBuilder() {
    }

    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder stringLeftIdent(@NotNull String stringLeftIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder stringRightIdent(@NotNull String stringRightIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder stringIdent(@NotNull String stringIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder rawVariableLeftIdent(@NotNull String rawVariableLeftIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder rawVariableRightIdent(@NotNull String rawVariableRightIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder mapLeftIdent(@NotNull String mapLeftIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder mapRightIdent(@NotNull String mapRightIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder mapKeyValueColumn(@NotNull String mapKeyValueColumn) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder mapEntryColumn(@NotNull String mapEntryColumn) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder arrayLeftIdent(@NotNull String arrayLeftIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder arrayRightIdent(@NotNull String arrayRightIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder arrayElementColumn(@NotNull String arrayElementColumn) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder objectLeftIdent(@NotNull String objectLeftIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder objectRightIdent(@NotNull String objectRightIdent) {
    ...
    @Contract("_ -> this")
    public DyanasisLexerSettingsBuilder stringPostProcessing(@NotNull Function<String, String> stringPostProcessing) {
    ...
    public DyanasisLexerSettings build() {
        DyanasisLexerSettings.Idents idents = new DyanasisLexerSettings.Idents();
        return new DyanasisLexerSettings(TODO);
    }

    @Override
    public DyanasisLexerSettingsBuilder clone() {
        return;
    }
}
