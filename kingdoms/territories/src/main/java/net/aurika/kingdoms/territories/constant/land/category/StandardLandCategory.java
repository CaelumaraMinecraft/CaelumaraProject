...
public class StandardLandCategory extends LandCategory {
  ...
  private static StandardLandCategory reg(String key, boolean editable, String name, String description) {
    return create(TerritoriesAddon.buildNS(key), editable, name, description);
  }

  private static LandCategory reg(String key, boolean editable) {
    return create(TerritoriesAddon.buildNS(key), editable);
  }
   ...
   */
  public static @NotNull StandardLandCategory create(
    ...
    return create(
        ...
        new DefaultedMessenger(
            new LanguageEntryMessenger(componentEntry(ns, "description")), () -> new StaticMessenger(description))
    );
  }
  ...
  protected static StandardLandCategory create(@NotNull Namespace ns, boolean editable, @NotNull Messenger name, @NotNull Messenger description) {
    ...
    TerritoriesAddon.get().landCategoryRegistry().register(landCategory);
    return landCategory;
  }
  ...
  public String getDescription(Language language) {
    return this.description.getProvider(language).getMessage().buildPlain(
