...
public enum CivilizationsAddonLang implements DefinedMessenger {
  ...
  CIVILIZATION_CREATE_FAILED_NO_ENOUGH_RP(
      "{$e}You don't have enough resource points to create a civilization.", 1, 2, 3),
  ...
  CIVILIZATION_DISBAND_TAX(
      "{$e}A civilization has been disbanded due to not being able to pay the taxes{$sep}: {$es}$%tax%", 1, 2),
