...
public class MessageHandler {
    ...
    public static void sendMessage(CommandSender resolver, String string, boolean usePrefix) {
        ...
        if (!Strings.isEmpty(string)) {
            MessageProcessor.compile(string, ).getSimpleProvider().send(resolver, (new MessageContextImpl()).usePrefix(usePrefix));
        }
    }
                    ...
                    for (int var5 = 0; var5 < maxInd; ++var5) {
                        ...
                        if (var6 == '\\') {
                            ...
                            if ((var7 = Strings.deleteWhitespace(str.substring(var5 + 1, var6))).length() >= 2) {
                                if (var7.charAt(0) == '#') {
                                    String var10;
                                    TextObject var12 = StandardKingdomsPlaceholder.getMacro(Strings.toLatinLowerCase(var10 = var7.substring(1)), MessageContext.messageContext());
                                    if (var12 != null) {
