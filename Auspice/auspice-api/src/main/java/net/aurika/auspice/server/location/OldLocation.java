  ...
  public boolean equals(@Nullable Object other) {
    if (!(other instanceof OldLocation)) {
      ...
      return Intrinsics.areEqual(
          this.getWorld(),
          ((OldLocation) other).getWorld()
      ) && this.getX() == ((OldLocation) other).getX() && this.getY() == ((OldLocation) other).getY() && this.getZ() == ((OldLocation) other).getZ() && this.getYaw() == ((OldLocation) other).getYaw() && this.getPitch() == ((OldLocation) other).getPitch();
    }
  }
