package net.aurika.auspice.scheduler;
...
public abstract class AbstractJavaScheduler implements TaskScheduleProvider {
  ...
  public AbstractJavaScheduler(BootstrapProvider var1) {
    this.a = var1;
    this.b = new ScheduledThreadPoolExecutor(
        1, (var0) -> {
  ...
  private void a(Predicate<Thread> var1) {
    Thread.getAllStackTraces().forEach((var2, var3) -> {
      if (var1.test(var2)) {
        this.a.getLogger().log(
            Level.WARNING,
            "Thread " + var2.getName() + " is blocked, and may be the reason for the slow shutdown!\n" + Arrays.stream(
                var3).map((var0) -> {
              return "  " + var0;
  ...
  private final class d implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread var1, Throwable var2) {
      try {
        AbstractJavaScheduler.this.a.getLogger().log(
            Level.WARNING, "Thread " + var1.getName() + " threw an uncaught exception", var2);
