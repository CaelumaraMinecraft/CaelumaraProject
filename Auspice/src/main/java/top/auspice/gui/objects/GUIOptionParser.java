...
import top.auspice.utils.string.ConfigPrinter;
...
public class GUIOptionParser {
    ...
    public GUIOptionParser(String var1, ConfigSection var2, ConfigSection var3, String var4, GUIInventoryConstructor var5, Map<Integer, String> var6, ArrayList<GUIOptionObject> var7) {
        this.a = var1;
        this.c = (ConfigSection) Objects.requireNonNull(var3, () -> {
            return "Null config: " + var1 + " | " + var4;
        });
        this.b = (ConfigSection) Objects.requireNonNull(var2, () -> {
    ...
    private ConditionalGUIOptionObject a(GUIOptionObject var1) {
        ...
        while (true) {
            ...
            do {
                if (!var4.hasNext()) {
                    return new ConditionalGUIOptionObject(var1, (GUIOptionObjectCondition[]) var2.toArray(new GUIOptionObjectCondition[0]));
                }
            ...
            if (!Strings.isNullOrEmpty(var7 = var6.getString(new String[]{"condition"}))) {
                ...
                try {
                    ...
                    KLogger.warn("Failed to parse conditional '" + (String) var5.getKey() + "' for option '" + this.a + "' for GUI " + var10.getName() + ", line " + var10.getLine() + '\n' + var8.getMessage());
                    continue;
                }
            } else {
                if (var3) {
            ...
            GUIOptionParser var9 = new GUIOptionParser((String) var5.getKey(), this.b, var6, this.d, this.e, this.k, this.extendParent(var1));
    ...
    public GUIOptionBuilder build() {
        ...
        if ((var2 = this.c.getString(new String[]{"[switch]"})) != null) {
            ...
            while (var5.hasNext()) {
                ...
                ConditionCompiler.BiLogicalOperator var8 = new ConditionCompiler.BiLogicalOperator(var10, ConditionCompiler.LogicalOperator.EQUALS, new ConditionCompiler.StringOperand(var7));
                var14 = new GUIOptionParser(var7, this.b, (ConfigSection) var6.getValue(), this.d, this.e, this.k, this.extendParent(var4));
            ...
            return new ConditionalGUIOptionObject(var4, (GUIOptionObjectCondition[]) var9.toArray(new GUIOptionObjectCondition[0]));
        } else {
    ...
    public GUIOptionObject parsePure(String var1, ConfigSection var2) {
            ...
            label170:
            {
                try {
                    ...
                    if ((var10 = (ItemStack) var6.a((Predicate) null, (Function) var13)) == null) {
                        var6.i = XItemStack.deserialize(var9.toBukkitConfigurationSection(), Function.identity(), var6.new a(var9, (byte) 0));
                    } else {
                        var6.i = XItemStack.edit(var10.clone(), var9.toBukkitConfigurationSection(), Function.identity(), var6.new a(var9, (byte) 0));
                    }
                } catch (Exception var19) {
                    Mark var11 = var2.getNode().getStartMark();
                    AuspiceLogger.error("Failed to parse item for option '" + this.a + "' for GUI " + this.d + ", line " + var11.getLine() + ":\n" + var19.getMessage());
                ...
                if ((var28 = this.i.getItemMeta()) != null) {
                    ...
                    if (var28.hasDisplayName()) {
                        this.f = TextCompiler.compile(var28.getDisplayName(), TextCompiler.defaultSettingsWithErrorHandler((var2x) -> {
                            Mark var3 = var2.getNode().getStartMark();
                            AuspiceLogger.warn("While parsing display name for '" + this.a + "' option in GUI '" + this.d + "', line " + var3.getLine() + ":\n" + var2x.joinExceptions());
                        }));
                    } else {
                        var13 = (var0) -> {
                    ...
                    if (!var28.hasLore()) {
                        ...
                        List var14 = TextCompiler.compile(String.join("\n", var12), TextCompiler.defaultSettingsWithErroHandler((var2x) -> {
                            ...
                            AuspiceLogger.warn("While parsing " + Numbers.toOrdinalNumeral(var3) + " line of lore for '" + this.a + "' option in GUI '" + this.d + "', line " + var4.getLine() + ":\n" + var2x.joinExceptions());
                        })).splitBy(false, (var0) -> {
                            return var0 instanceof TextPiece.NewLine;
                        });
        ...
        if ((var5 = var2.getString(new String[]{"interaction"})) == null) {
            ...
            if (!(var22 = Enums.getIfPresent(GUIInteractionType.class, var5)).isPresent()) {
                ...
                KLogger.warn("While parsing the 'interaction' of " + var1 + "' option in GUI '" + this.d + "', line " + var7.getLine() + ":\nUnknown interaction type: " + var5);
            }
        ...
        if ((var23 = var2.getString(new String[]{"message"})) == null) {
            ...
            var10000 = TextCompiler.compile(var23, TextCompiler.defaultSettingsWithErrorHandler((var3x) -> {
                Mark var4 = var2.getNode("message").getStartMark();
                AuspiceLogger.warn("While parsing the 'message' of " + var1 + "' option in GUI '" + this.d + "', line " + var4.getLine() + ":\n" + var3x.joinExceptions());
            }));
        }
        ...
        if (!var24.isEmpty()) {
            ...
            if (!var26.isSet(new String[]{"slot"})) {
                ...
                if (!var30) {
                    if (var32 <= 0 || var32 > 9) {
                        MessageHandler.sendConsolePluginMessage("&4Invalid GUI X position&8: &e" + var32 + " &7- &cMust be between 0 and 9");
                        ConfigPrinter.printConfig(var26);
                        return null;
                    }

                    if (var34 <= 0 || var34 > 6) {
                        MessageHandler.sendConsolePluginMessage("&4Invalid GUI Y position&8: &e" + var34 + " &7- &cMust be between 0 and 6");
                        ConfigPrinter.printConfig(var26);
                        return null;
                    }
        ...
        for (var15 = 0; var15 < var37; ++var15) {
            ...
            if (!var35.add(var16)) {
                MessageHandler.sendConsolePluginMessage("&4Repeated slot position &e" + var16 + " &4for option &e" + var6.a + " &4in GUI &e" + var6.d);
                var36 = true;
            } else if (var16 < 0) {
                MessageHandler.sendConsolePluginMessage("&4Negative slot position &e" + var16 + " &4for option &e" + var6.a + " &4in GUI &e" + var6.d);
                var36 = true;
            } else if (var16 > var6.e.getMaxSize()) {
                MessageHandler.sendConsolePluginMessage("&4Slot position &e" + var16 + " &4for option &e" + var6.a + " &4in GUI &e" + var6.d + " &4is greater than the allowed slot position in GUI of type &e" + var6.e.getType() + " &4with maximum slots of &e" + var6.e.getMaxSize());
                var36 = true;
            } else {
                String var17;
                if (!var30 && (var17 = (String) var6.k.get(var16)) != null) {
                    MessageHandler.sendConsolePluginMessage("&4Duplicated slot position &e" + var16 + " &4for option &e" + var6.a + " &4in GUI &e" + var6.d + " &4which is already taken by &e" + var17 + " &4option.");
                    var36 = true;
                }
            }
        }
