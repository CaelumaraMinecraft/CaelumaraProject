...
public class KingdomsPlaceholderTranslationContext {
    ...
    @NotNull
    public final TextPlaceholderProvider asMessageBuilder() {
        if (this.a instanceof TextPlaceholderProvider) {
            return (TextPlaceholderProvider)this.a;
        } else {
            TextPlaceholderProvider var10000 = (TextPlaceholderProvider) (new TextPlaceholderProvider()).inheritContext(this.a, true);
