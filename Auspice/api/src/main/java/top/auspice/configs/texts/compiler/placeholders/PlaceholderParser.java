...
import top.auspice.configs.texts.compiler.placeholders.PlaceholderLexer.CharTokenType;
import top.auspice.configs.texts.compiler.placeholders.functions.PlaceholderFunctionData;
import top.auspice.configs.texts.compiler.placeholders.functions.PlaceholderFunctionParameters;
import top.auspice.configs.texts.compiler.placeholders.functions.PlaceholderNamedFunctionParameters;
import top.auspice.configs.texts.compiler.placeholders.functions.PlaceholderPositionalFunctionParameters;
import top.auspice.configs.texts.compiler.placeholders.modifiers.PlaceholderModifier;
import top.auspice.configs.texts.compiler.placeholders.types.ExternalOrLocalPlaceholder;
import top.auspice.configs.texts.compiler.placeholders.types.KingdomsPlaceholder;
import top.auspice.configs.texts.compiler.placeholders.types.PermissionPlaceholder;
    ...
    public static Map<String, Object> serializeVariables(boolean checkSpecialType, @Nullable Map<String, Object> container, @NonNull Object[] edits) {
        if (edits.length != 0) {
            ...
            for (int indexToStr = 0; indexToStr < max; indexToStr += 2) {
                ...
                if (!checkSpecialType && !object.getClass().isPrimitive() && !(object instanceof Messenger) && !(object instanceof MessageObjectBuilder)) {
