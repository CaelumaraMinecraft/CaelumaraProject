...
public final class CommandSession extends KingdomsCommand {
            ...
            if (var6 != null) {
                ...
                if (var7 != null) {
                    ...
                    if (var8 != null) {
                        ...
                        if (var9 != null) {
                            Session var4 = var9;
                            if (!var9.getAuthorizedBy().test(PlayerUtils.getUniqueId(((SimpleMessenger) var1).getMessageReceiver()))) {
    ...
    public static final class Companion {
        ...
        public Session addSession(@NotNull CommandContext var1, @NotNull Duration var2, @NotNull SessionCallback var3) {
            ...
            var1.getTextContext().raw("command_session_id", var6.getId());
            var1.getTextContext().raw("command_namespace", var6.getNamespace().asString());
        ...
        private static boolean a(CommandContext var0, UUID var1) {
            Intrinsics.checkNotNullParameter(var0, "");
            Intrinsics.checkNotNullParameter(var1, "");
            return Intrinsics.areEqual(var1, PlayerUtils.getUniqueId(((SimpleMessenger) var0).getMessageReceiver()));
        }
    }
