...
public final class MathUtils {
    ...
    public static double eval(MathExpression mathExpression, PlaceholderProvider placeholderProvider) {
        return mathExpression.eval((varName) -> expectDouble(varName, placeholderProvider.providePlaceholder(varName)));
    }
