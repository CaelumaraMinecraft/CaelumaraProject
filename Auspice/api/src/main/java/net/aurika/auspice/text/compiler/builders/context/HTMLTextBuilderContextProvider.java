...
public class HTMLTextBuilderContextProvider extends TextBuilderContextProvider {
  ...
  public static void addHandler(MessagePlaceholderProvider var0) {
    var0.addChild("html", new StyleHandler(var0));
    var0.addChild("htmlStyle", new PlaceholderHandler(var0));
  }

  public HTMLTextBuilderContextProvider(MessagePlaceholderProvider var1) {
    super(var1);
  }
  ...
  private static final class StyleHandler implements PlaceholderProvider {
    ...
    private StyleHandler(MessagePlaceholderProvider var1) {
      this.a = var1;
    }
  ...
  private static final class PlaceholderHandler implements PlaceholderProvider {
    ...
    private final MessagePlaceholderProvider placeholderProvider;

    private PlaceholderHandler(MessagePlaceholderProvider placeholderProvider) {
    ...
    public Object providePlaceholder(String name) {
      ...
      Object var2 = variablePiece.getVariable(this.placeholderProvider);
      if (var2 == null) {
        return null;
      } else {
        TextObject var5;
        if (var2 instanceof TextObjectBuilder) {
          var5 = ((TextObjectBuilder) var2).evaluateDynamicPieces(this.placeholderProvider);
