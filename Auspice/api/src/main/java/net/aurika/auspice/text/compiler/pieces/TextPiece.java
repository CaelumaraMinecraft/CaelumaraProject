...
public abstract class TextPiece implements AbstractTextPiece {
    ...
    public static final class Hover extends TextPiece {
        ...
        public void build(ComplexTextBuilderContextProvider builderProvider) {
            PlainTextBuilderContextProvider clickActionBuilder = new PlainTextBuilderContextProvider(builderProvider.settings());
            ...
            ComplexTextBuilderContextProvider normalMessageBuilder = new ComplexTextBuilderContextProvider(builderProvider, plainTextBuilder, builderProvider.settings());
            ...
            ComplexTextBuilderContextProvider hoverMessageBuilder = new ComplexTextBuilderContextProvider(builderProvider, builderProvider.settings());
