...
public final class PlaceholderModifierShort implements PlaceholderModifier {
    ...
    public Object apply(@NotNull Placeholder placeholder, @Nullable Object object) {
        ...
        if (!(object instanceof Number)) {
            throw new PlaceholderModifierException("Unsupported placeholder value for modifier '" + this.getName() + "' with value (" + (object != null ? object.getClass() : null) + ") " + object + " for placeholder: " + placeholder);
        } else {
