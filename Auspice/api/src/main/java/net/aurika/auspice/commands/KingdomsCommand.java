...
public abstract class KingdomsCommand {
  ...
  public KingdomsCommand(@org.intellij.lang.annotations.Pattern("[a-zA-Z0-9]+") @NonNull String var1, @Nullable KingdomsParentCommand var2, PermissionDefaultValue permissionDefaultValue) {
    ...
    if (!a.matcher(var1).matches()) {
      ...
      ConfigSection var15 = AuspiceGlobalConfig.COMMANDS.getSection().getSection().getSection(
          ConfigPath.buildRaw(Strings.replace(var4, '.', ".commands.").toString()));
      ...
      if (var15 != null) {
        ...
        if (!var17 && !com.google.common.base.Strings.isNullOrEmpty(
            var7 = var15.getString(new String[]{"permission-default"}))) {
          permissionDefaultValue = (PermissionDefault) BukkitPermission.DEFAULT_VALUE_MAPPING.get(
              PermissionDefaultValue.valueOf(var7));
        }
      }

      this.permission = new Permission(
          "kingdoms.command." + var4, this.description.parse(new Object[0]),
          permissionDefaultValue == null ? (var2 == null ? PermissionDefault.OP : ((KingdomsCommand) var2).getPermission().defaultValue()) : permissionDefaultValue
      );
      this.bypassDisabledWorldsPermission = new Permission(
          "kingdoms.command." + var4 + ".bypass.disabled-worlds",
          "Permission to use this command even when it's disabled in a certain world."
      );
      this.bypassCooldownPermission = new Permission(
          "kingdoms.command." + var4 + ".bypass.cooldown", "Permission to bypass the command cooldown.");
      if (var15 == null && !var17) {
        this.cooldown = 0L;
        ...
        this.cooldown = com.google.common.base.Strings.isNullOrEmpty(var7) ? 0L : Optional.ofNullable(
            TimeUtils.parseTime(var7)).orElseThrow(() -> {
      ...
      if (permissionDefaultValue == null && var2 != null) {
        this.permission.setDefault(((KingdomsCommand) var2).getPermission().defaultValue());
      }
      ...
      while (var13.hasNext()) {
        ...
        Map var16 = (Map) var18.computeIfAbsent(
            var14, (var0) -> {
        ...
        try {
          ...
          String var8 = this.getDisplayName().getMessageObject(var14).build(MessageContextImpl.DEFAULT);
          ...
          if (var19 != null) {
            String[] var20 = Strings.splitArray(var19.build(MessageContextImpl.DEFAULT), ' ');
            ...
            for (int var9 = 0; var9 < var21; ++var9) {
              ...
              if ((var11 = (KingdomsCommand) var16.put(var10.toLowerCase(var14.getLocale()), this)) != null) {
                AuspiceLogger.warn(
                    "The alias '" + var10 + "' for command '" + var4 + "' has overridden command '" + var11.name + '\'');
              }
            }
          } else {
  ...
  public KingdomsCommand(
      @org.intellij.lang.annotations.Pattern("[a-zA-Z0-9]+") @NonNull String name,
  ...
  public void unregisterPermissions() {
    Iterator var1 = Arrays.asList(
        this.permission, this.bypassCooldownPermission, this.bypassDisabledWorldsPermission).iterator();
  ...
  public static String processTabMessage(String var0) {
    ...
    return COLORIZE_TAB_COMPLETES ? var1.buildPlain(MessageContextImpl.DEFAULT) : var1.buildPlain(
        (new MessageContextImpl()).ignoreColors());
  }
  ...
  public final @NonNull Messenger getDisplayName() {
    return new DefaultedMessenger(
        this.lang("name"), () -> {
      return new StaticMessenger(
          TextObject.textObject(Boolean.FALSE, TextCompilerSettings.NONE_SETTINGS, new TextPiece.Plain(this.name)));
    }
    );
  }
  ...
  static {
    COLORIZE_TAB_COMPLETES = XReflection.supports(
        13) && AuspiceGlobalConfig.COMMAND_ENABLE_TAB_COLORIZATION.getBoolean();
