...
public abstract class KingdomsCommand {
    ...
    public KingdomsCommand(@org.intellij.lang.annotations.Pattern("[a-zA-Z0-9]+") @NonNull String var1, @Nullable KingdomsParentCommand var2, PermissionDefaultValue permissionDefaultValue) {
        ...
        if (!a.matcher(var1).matches()) {
            ...
            this.permission = new Permission("kingdoms.command." + var4, this.description.parse(new Object[0]), permissionDefaultValue == null ? (var2 == null ? PermissionDefault.OP : ((KingdomsCommand)var2).getPermission().defaultValue()) : permissionDefaultValue);
    ...
    public static String processTabMessage(String var0) {
        ...
        return COLORIZE_TAB_COMPLETES ? var1.buildPlain(MessageContextImpl.DEFAULT) : var1.buildPlain((new MessageContextImpl()).ignoreColors());
    }
    ...
    public final @NonNull Messenger getDisplayName() {
        return new DefaultedMessenger(this.lang("name"), () -> {
            return new StaticMessenger(TextObject.textObject(Boolean.FALSE, TextCompilerSettings.NONE_SETTINGS, new TextPiece.Plain(this.name)));
        });
    }
