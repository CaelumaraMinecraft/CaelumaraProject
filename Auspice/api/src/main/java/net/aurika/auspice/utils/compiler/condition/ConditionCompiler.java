...
public final class ConditionCompiler {
  ...
  private void a(LogicalOperand var1, boolean var2, Supplier<String> var3) {
    ...
    if ((var4 = this.e.peekLast()) != null && var4.unary) {
      if (!var4.acceptsOperandOfType(var1)) {
        throw this.a(
            this.f,
            "Right hand side of '" + var4.symbol + "' unary operator must be " + var4.acceptedOperands[0] + " expression",
            var3.get()
        );
      }
  ...
  private BiLogicalOperator a(LogicalOperand var1, LogicalOperator var2, LogicalOperand var3) {
    if (!var2.acceptsOperandOfType(var1)) {
      throw this.a(
          this.h,
          "Left hand side of '" + var2.symbol + "' operator must be " + var2.acceptedOperands[0] + " expression",
          var2.symbol
      );
    } else if (!var2.acceptsOperandOfType(var3)) {
      throw this.a(
          this.f,
          "Right hand side of '" + var2.symbol + "' operator must be " + var2.acceptedOperands[0] + " expression",
          var2.symbol
      );
    } else {
  ...
  public void handleOp() {
    if (this.g != -1) {
        ...
        if (var4 == var8.symbolSize() && var9.equals(var3)) {
          ...
          if (!this.e.isEmpty()) {
            if (!var8.unary && this.d.size() < 2) {
              throw this.a(
                  this.h - var10.symbolSize(), "Blank operand on right side of '" + var10.symbol + "' binary operator.",
                  var10.symbol
              );
            }
            ...
            if (var10.unary) {
              throw this.a(
                  this.f, "Unary operator '" + var10.symbol + "' was followed by another operator " + var8.symbol,
                  var8.symbol
              );
            }
          }
      ...
      if (var3.startsWith("!!")) {
        ...
        var11 = Arrays.stream(LogicalOperator.OPERATORS).filter((var1) -> var3.contains(var1.symbol)).findFirst().map(
            (var0) -> " (hint: You have to write '" + var0.symbol + "' operator separated with a space from other operators)").orElse(
            "");
      }
    ...
    public Boolean eval(@NotNull ConditionVariableTranslator variableTranslator) {
      ...
      if (!(evaled instanceof Boolean)) {
        ...
        throw new LogicalException(
            "Not a boolean expression: " + evaled + " (" + (evaled == null ? null : evaled.getClass()) + ')');
      } else {
  ...
  public enum LogicalOperator {
    ...
    LogicalOperator(String symbol, int priority, AcceptedOperand[] var5, boolean isUnary) {
      if (var5.length != 0 && var5.length <= 3) {
        ...
        throw new AssertionError(
            "Invalid list of accepted operands: " + Arrays.toString(var5) + " for operator " + symbol);
      }
    }
    ...
    public Double assertNumber(Object obj) {
      if (obj instanceof Double) {
        ...
        throw new LogicalException(
            "Operands of '" + this.symbol + "' operator must be numbers instead got: '" + obj + "' (" + (obj == null ? null : obj.getClass().getName() + ')'));
      }
    }
    ...
    public boolean assertBool(Object obj) {
      if (obj instanceof Boolean) {
        ...
        throw new LogicalException(
            "Operands of '" + this.symbol + "' operator must be booleans instead got: '" + obj + "' (" + (obj == null ? null : obj.getClass().getName() + ')'));
      }
    }
