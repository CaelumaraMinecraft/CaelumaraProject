...
public class CommandContext extends SimpleMessenger {
    ...
    public AnyNumber getNumber(int var1, boolean var2, boolean var3, Messenger var4) {
        Pair var5;
        if ((var5 = this.getNumber(var1, var4, FunctionalList.create().addIf(var2, NumberConstraint.INTEGER_ONLY).addIf(var3, NumberConstraint.POSITIVE).toArray(new NumberConstraint[0]))).getValue() != null) {
