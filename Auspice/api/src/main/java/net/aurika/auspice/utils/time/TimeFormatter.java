package net.aurika.auspice.utils.time;
...
public class TimeFormatter {
  ...
  public static TextObjectBuilder of(Duration var0) {
    return of(var0.toMillis());
  }

  public static TextObjectBuilder of(long var0) {
  ...
  public String toString() {
    ...
    if (this.absoluteMinutes == 0L) {
      ...
      return this.absoluteMonths == 0L ? var1 + this.a("wwwwa week(s), dd day(s), hh:mm:ss") : var1 + this.a(
          "yyyy years, MMA month(s), wwww week(s), dd day(s), hh:mm:ss");
    }
  }

  private Object[] a() {
    return new Object[]{"yyyy", this.years, "MM", this.months, "MMA", this.absoluteMonths, "wwww", this.weeks, "wwwwa", this.absoluteWeeks, "dd", this.days, "dda", this.absoluteDays, "hh", this.hours, "hha", this.absoluteHours, "hhf", a(
        this.hours), "hhaf", a(this.absoluteHours), "mm", this.minutes, "mmf", a(
        this.minutes), "mma", this.absoluteMinutes, "mmaf", a(
        this.absoluteMinutes), "ss", this.seconds, "ssa", this.absoluteSeconds, "ssf", a(this.seconds), "ssaf", a(
  ...
  public static TextObjectBuilder dateOf(long var0) {
    return new RawLanguageEntryObjectBuilder(
        AuspiceLang.DATE_FORMATTER, (var2) -> {
      try {
        return TimeUtils.formatTime(
            DateTimeFormatter.ofPattern(var2).withZone(TimeZoneHandler.SERVER_TIME_ZONE), Instant.ofEpochMilli(var0),
            20
        ).toString();
      } catch (IllegalArgumentException var4) {
        AuspiceLogger.error(
            "Illegal character '" + var2 + "' inside 'date-formatter' inside language file: " + var4.getMessage());
  ...
  public TextObjectBuilder getFormat() {
    String var1;
    if (this.absoluteMinutes == 0L) {
      var1 = "SECONDS";
    } else if (this.absoluteHours == 0L) {
    ...
    MessageContextImpl var2 = (new MessageContextImpl()).raws(this.a());
