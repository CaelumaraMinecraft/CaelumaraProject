...
import net.aurika.auspice.constants.top.ExpressionBasedTopData;
...
public abstract class TopPlaceholders<K, V> extends FunctionalPlaceholder {
  ...
  public final Object value(
      @NotNull KingdomsPlaceholderTranslationContext context,
  ...
  @PhFn
  @Nullable
  public final Object isIncluded(
      @NotNull KingdomsPlaceholderTranslationContext context,
      @NotNull PlaceholderFunctionInvoker invoker,
      @PhParam(name = "type") @NotNull String type
  ) {
  ...
  public final Object at(
      @NotNull PlaceholderFunctionInvoker var1,
