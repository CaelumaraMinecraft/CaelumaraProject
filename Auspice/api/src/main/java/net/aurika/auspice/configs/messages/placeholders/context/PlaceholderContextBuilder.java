...
public interface PlaceholderContextBuilder extends LocalVariableProvider, PlaceholderTargetProvider, Cloneable {
    ...
    default @Nullable Object provideLocalVariable(@NotNull PlaceholderParts parts) {
        ...
        if (this.variables() != null && var2 != null) {
            ...
            if (this.children() != null && var3 != null) {
                ...
                return this.unknownPlaceholderHandler() != null && (var2 = this.unknownPlaceholderHandler().provideVariable(parts.full())) != null ? PlaceholderTranslationContext.unwrapPlaceholder(var2) : null;
            }
        }
    }
    ...
    default PlaceholderContextBuilder addChild(@NotNull String name, VariableProvider variableProvider) {
        ...
        if (name.contains("_")) {
            throw new IllegalArgumentException("Child element name cannot contain underscore, consider nesting groups instead or using another name: " + name);
        } else {
            this.impregnate(1);
