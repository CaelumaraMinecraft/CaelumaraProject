package net.aurika.auspice.server.bukkit.platform.item;

import com.cryptomorin.xseries.reflection.XReflection;
import com.cryptomorin.xseries.reflection.minecraft.MinecraftMapping;
import com.cryptomorin.xseries.reflection.minecraft.MinecraftPackage;
import net.aurika.auspice.server.bukkit.platform.adapers.BukkitAdapter;
...
public final class ItemNBT {
  ...
  static {
    ...
    Class<?> crafItemStack = XReflection.ofMinecraft().inPackage(MinecraftPackage.CB, "inventory").named(
        "CraftItemStack").unreflect();
    Class<?> nmsItemStack = XReflection.ofMinecraft().inPackage(MinecraftPackage.NMS, "world.item").named(
        "ItemStack").unreflect();
    ...
    try {
      ...
      asBukkitCopy = lookup.findStatic(
          crafItemStack, "asBukkitCopy", MethodType.methodType(ItemStack.class, nmsItemStack));
    ...
    try {
      // 1.20.5 "components"
      Class<?> DataComponentsClass = XReflection.ofMinecraft().inPackage(MinecraftPackage.NMS, "core.component").named(
          "DataComponents").reflect();
      Class<?> DataComponentHolderClass = XReflection.ofMinecraft().inPackage(
          MinecraftPackage.NMS, "core.component").named("DataComponentHolder").reflect();
      Class<?> DataComponentTypeClass = XReflection.ofMinecraft().inPackage(
          MinecraftPackage.NMS, "core.component").named("DataComponentType").reflect();
      Class<?> CustomDataClass = XReflection.ofMinecraft().inPackage(
          MinecraftPackage.NMS, "world.item.component").named("CustomData").reflect();
       ...
       * }
       */
      setTag = lookup.findVirtual(
          nmsItemStack, XReflection.v(20, 5, "b").orElse("set"),
       ...
       * }
       */
      getTag = lookup.findVirtual(
          nmsItemStack, XReflection.v(20, 5, "a").orElse("get"),
       ...
       * }
       */
      copyTag = lookup.findVirtual(
          CustomDataClass, XReflection.v(20, 5, "c").orElse("copyTag"),
