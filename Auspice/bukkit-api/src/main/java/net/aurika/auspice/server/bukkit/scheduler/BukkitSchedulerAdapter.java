package net.aurika.auspice.server.bukkit.scheduler;
...
public class BukkitSchedulerAdapter extends AbstractJavaScheduler {
  ...
  private final class c implements TaskScheduler {
    ...
    public DelayedTask delayed(@NotNull Duration delay, @NotNull Runnable runnable) {
      int var3 = BukkitSchedulerAdapter.this.b.scheduleSyncDelayedTask(
          BukkitSchedulerAdapter.this.c, new TracedRunnable(runnable), TickTemporalUnit.toTicks(delay));
    ...
    public DelayedRepeatingTask repeating(@NotNull Duration var1, @NotNull Duration var2, @NotNull Runnable var3) {
      int var4 = BukkitSchedulerAdapter.this.b.scheduleSyncRepeatingTask(
          BukkitSchedulerAdapter.this.c, new TracedRunnable(var3), TickTemporalUnit.toTicks(var1),
          TickTemporalUnit.toTicks(var2)
      );
