...
public final class OldEventPropagator {
    ...
    public static final class Dismount implements Listener, EventPropagator {
        ...
        public void onEntityDismount(EntityDismountEvent event) {
            net.aurika.auspice.server.event.EntityDismountEvent delegate = new net.aurika.auspice.server.event.EntityDismountEvent(event.getEntity(), event.getDismounted());
