package net.aurika.auspice.game.bukkit.utils.cache.single;
...
public class TickedCache<T> implements CacheableObject<T> {
  ...
  public boolean hasExpired() {
    return this.value == null || Server.get().ticks() - this.lastUpdateTicks >= this.expirationTicks;
  }
  ...
  public void set(T value) {
    this.value = value;
    this.lastUpdateTicks = Server.get().ticks();
  }
