...
public final class BukkitPermission implements Permission {
    ...
    public @NotNull String toString() {
        StringBuilder sb = (new StringBuilder("BukkitPermission(permission=")).append(this.perm).append(", namespace='").append(this.namespace()).append("', name=");
        String var10001 = Arrays.toString(this.name());
        Intrinsics.checkNotNullExpressionValue(var10001, "");
        return sb.append(var10001).append(", defaultValue=").append(this.defaultValue()).append(", description=").append(this.description()).append(", split=").append(this.key.toFullName()).append(')').toString();
    }
}