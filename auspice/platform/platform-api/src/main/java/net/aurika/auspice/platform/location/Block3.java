...
public class Block3 implements Block3D, DataStringRepresentation {

  private final int x;
  private final int y;
  private final int z;

  public Block3(int x, int y, int z) {
    this.x = x;
    this.y = y;
    this.z = z;
  }
  ...
  @NotNull
  public final Block2 getChunkLocation() {
    return Block2.of(this.getX() >> 4, this.getZ() >> 4);
  }

  @NotNull
  public final Block3 add(@NotNull Number x, @NotNull Number y, @NotNull Number z) {
  ...
  @NotNull
  public final Block3 add(@NotNull Block3D other) {
    Objects.requireNonNull(other);
    return this.add(other.getX(), other.getY(), other.getZ());
  }

  @NotNull
  public final Block3 subtract(@NotNull Block3D other) {
    Objects.requireNonNull(other);
    return this.subtract(other.getX(), other.getY(), other.getZ());
  }

  @NotNull
  public final Block3 subtract(@NotNull Number x, @NotNull Number y, @NotNull Number z) {
    Objects.requireNonNull(x);
    Objects.requireNonNull(y);
    Objects.requireNonNull(z);
    return of(this.getX() - x.intValue(), this.getY() - y.intValue(), this.getZ() - z.intValue());
  ...
  public final boolean containedWithin(@NotNull Block3 min, @NotNull Block3 max) {
  ...
  @NotNull
  public final Block3 getMinimum(@NotNull Block3 v2) {
    Objects.requireNonNull(v2);
    return of(Math.min(this.getX(), v2.getX()), Math.min(this.getY(), v2.getY()), Math.min(this.getZ(), v2.getZ()));
  }

  @NotNull
  public final Block3 getMaximum(@NotNull Block3 v2) {
    Objects.requireNonNull(v2);
  ...
  public boolean equals(@Nullable Object other) {
    if (!(other instanceof Block3)) {
      ...
      return this.getX() == ((Block3) other).getX() && this.getY() == ((Block3) other).getY() && this.getZ() == ((Block3) other).getZ();
    }
  }
  ...
  @NotNull
  public static Block3 of(int x, int y, int z) {
    return new Block3(x, y, z);
  }

  @NotNull
  public static Block3 of(@NotNull Block3D other) {
    Objects.requireNonNull(other);
    return of(other.getX(), other.getY(), other.getZ());
  }

  @NotNull
  public static Block3 fromString(@NotNull String str) {
