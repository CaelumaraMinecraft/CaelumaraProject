...
public class OptionHandler implements ContextualMessenger {
  ...
  public void startConversation() {
    if (this.object == null) {
      throw new IllegalStateException(
          "Cannot start a conversation for an option that's not pushed to the GUI: " + this.holder + " in GUI " + this.gui.getName());
    } else {
  ...
  public void pushHead(OfflinePlayer var1, boolean var2) {
    if (var1 != null) {
      ...
      this.settings.parse(
          "online",
          (var1.isOnline() ? AuspiceLang.PLAYERS_ONLINE : AuspiceLang.PLAYERS_OFFLINE).parse(var1, new Object[0])
      );
