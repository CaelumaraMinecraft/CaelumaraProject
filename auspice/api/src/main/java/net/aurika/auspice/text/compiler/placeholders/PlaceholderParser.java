...
public final class PlaceholderParser {
  ...
  private RuntimeException a(PlaceholderLexer.Token var1, String var2) {
    throw new PlaceholderParseException(
        var2 + " for token " + var1 + " at " + var1.getStartIndex() + " in placeholder '" + this.h.getFullString() + '\'');
  }

  private void a(int var1, int var2, String var3) {
    throw new PlaceholderParseException(var3 + " at " + var1 + " '" + this.h.getFullString().substring(
        var1,
        var2
    ) + "' in placeholder '" + this.h.getFullString() + '\'');
  }
  ...
  private void a(boolean var1) {
    ...
    if ((var3 = this.a((String) null)) != null) {
      if (var3.equals("other")) {
        ...
        Optional<PlaceholderModifier> var4 = PlaceholderModifier.getRegistered().values().stream().filter(
            (var1x) -> var1x.getName().equals(var3)).findFirst();
        if (var4.isPresent()) {
  ...
  public Placeholder getPlaceholder() {
              ...
              if (this.a(var10, null)) {
                ...
                if (this.a(var10, null)) {
                  ...
                  if (!this.a(var10, null) && this.j.hasNext()) {
                    throw this.a(
                        this.i,
                        "Unexpected character in function parameters '" + var21 + "' - '" + var8 + "' - " + this.j.current()
                    );
                  }
    ...
    Optional<PlaceholderModifier> var17 = this.g.stream().filter(
        (var0) -> !var0.isSupported(Boolean.class)).findFirst();
    if (this.d.equals("perm") && var17.isPresent()) {
      this.a(
          this.j.previous(), "Modifier '" + var17.get().getName() + "' is not supported for permission placeholders");
    }
    ...
    if (this.f != null && var12 instanceof KingdomsPlaceholder && (var19 = (KingdomsPlaceholder) var12).identifier.getFunctions() != null) {
      ...
      if (var16 == null) {
        this.a(
            this.j.previous(),
            "Unknown function '" + this.f.getFunctionName() + "' for kingdoms placeholder '" + var19.identifier + '\''
        );
      }
      ...
      if (this.f.getParameters() instanceof PlaceholderNamedFunctionParameters var22) {
        ...
        for (FunctionalPlaceholder.Parameter parameter : var16.getParameters()) {
          ...
          if (!(var26 = parameter).getOptional() && !var26.getType().isInternal() && !var22.getParameters().containsKey(
              var26.getName())) {
      ...
      for (PlaceholderModifier var27 : var2.g) {
        ...
        if (var20 == null) {
          ...
          switch (var20.compareCompatibilityWith(var27)) {
            ...
            case AFTER:
              var2.a(
                  var2.k.b.getStart(), var2.k.b.getEndInclusive(),
                  "Incompatible placeholder modifiers, the order must be switched " + var8
              );
          }
        }
      }
