...
public abstract class FunctionalPlaceholder implements Function1<KingdomsPlaceholderTranslationContext, Object> {
  ...
  public FunctionalPlaceholder() {
    ...
    for (int var4 = var10000.length; var3 < var4; ++var3) {
      Method var5;
      if ((var5 = var10000[var3]).getAnnotation(PhFn.class) != null) {
        ...
        for (int var10 = var25.length; var9 < var10; ++var9) {
          ...
          PhParam var12;
          String var26;
          if ((var12 = (var11 = var25[var9]).getAnnotation(PhParam.class)) != null) {
            var26 = var12.name();
          ...
          if (Intrinsics.areEqual(paramType, Integer.TYPE)) {
            ...
            if (!Intrinsics.areEqual(paramType, AuspicePlayer.class)) {
              throw new IllegalArgumentException(
                  "Unsupported argument type " + var11.getType() + " for parameter " + var20 + " in function " + var6);
            }
  ...
  public Object invoke(@NotNull KingdomsPlaceholderTranslationContext var1) {
    ...
    String[] var2;
    var1.getPlaceholder().requireFunction(
        Arrays.copyOf(var2 = (String[]) ((Collection) this.a.keySet()).toArray(new String[0]), var2.length));
  ...
  public final class CompiledFunction {
    ...
    public Object invoke(@NotNull KingdomsPlaceholderTranslationContext var1) {
      ...
      for (Parameter parameter : this.c) {
        ...
        Object var12;
        if (parameter.getOptional() && !parameter.getType().isInternal() && !var10.has(paramName)) {
          var12 = null;
        } else {
          switch (parameter.getType()) {
            case STRING:
              var12 = var10.getString(paramName);
              break;
            case INT:
              var12 = var10.getInt(paramName);
              break;
            case BOOL:
              var12 = var10.getBool(paramName);
              break;
            case CONTEXT:
              var12 = var1;
              break;
