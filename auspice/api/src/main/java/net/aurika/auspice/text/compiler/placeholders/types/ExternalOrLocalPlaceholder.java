...
public final class ExternalOrLocalPlaceholder extends AbstractPlaceholder {
  ...
  public Object request(@NotNull PlaceholderProvider provider) {
    ...
    Object var2;
    if (!this.a && provider instanceof LocalPlaceholderProvider && (var2 = ((LocalPlaceholderProvider) provider).provideLocalPlaceholder(
        new PlaceholderParts(this.b + (this.c != null ? "_" + this.c : "")))) != null) {
      return var2;
      ...
      BasePlaceholderTargetProvider var3 = ((PlaceholderTargetProvider) provider).getTargetProviderFor(
          this.getPointer());
