...
public class MessageHandler {
    ...
    if (var0.charAt(0) == '&') {
      ...
      if (var0.indexOf(44) > 1) {
        ...
        if (length == 3) {
          ...
          a(var0);
          return "§" + 'x' + "§" + var0.charAt(0) + '§' + var0.charAt(1) + "§" + var0.charAt(2) + '§' + var0.charAt(
              3) + "§" + var0.charAt(4) + '§' + var0.charAt(5);
        } else {
  ...
  private static void a(String var0) {
    ...
    for (int var2 = 0; var2 < var1; ++var2) {
      if (!TextFormatCodes.isColorCode(var0.charAt(var2))) {
    ...
    if (var1 != null && var1.length != 0 && !com.google.common.base.Strings.isNullOrEmpty(var0)) {
      if (var1[0] instanceof Collection) {
        ...
        throw new IllegalArgumentException(
            "No replacement is specified for the last variable: \"" + var1[var1.length - 1] + "\" in \"" + var0 + '"' + " with edits: \"" + Arrays.toString(
                var1) + '"');
      } else {
  ...
  public static String replaceVariables(String var0, List<Object> var1) {
    if (var1 != null && !var1.isEmpty() && !Strings.isNullOrEmpty(var0)) {
      if (var1.get(0) instanceof Collection) {
        ...
        throw new IllegalArgumentException("No replacement is specified for the last variable: \"" + var1.get(
            var1.size() - 1) + "\" in \"" + var0 + '"' + " with edits: \"" + Arrays.toString(var1.toArray()) + '"');
      } else {
        String var2 = null;
  ...
  public static void sendMessage(CommandSender resolver, String string, boolean usePrefix) {
    ...
    if (!Strings.isEmpty(string)) {
      MessageProcessor.compile(string, ).getSimpleProvider().send(
          resolver, (new MessageContextImpl()).usePrefix(usePrefix));
    }
  }
      ...
      if (Auspice.QUANTUM_STATE) {
        ...
        if (!SIXTEEN) {
          ...
          for (index = 0; index < maxInd; ++index) {
            if (var9[index] == '&' && TextFormatCodes.isTextFormatCode(var9[index + 1])) {
              var9[index++] = '§';
            }
          }
          ...
          for (int var5 = 0; var5 < maxInd; ++var5) {
            ...
            if (var6 == '\\') {
              ...
              if (var4) {
                ...
                if (TextFormatCodes.isColorCode((char) var6)) {
                ...
                boolean var13 = var11 == '#';
                if (!var13 && !TextFormatCodes.isTextFormatCode(var11)) {
                  builder.append('&');
                } else {
                  builder.append('§');
                  if (var13) {
              ...
              if ((var7 = Strings.deleteWhitespace(str.substring(var5 + 1, var6))).length() >= 2) {
                if (var7.charAt(0) == '#') {
                  String var10;
                  TextObject var12 = StandardKingdomsPlaceholder.getMacro(
                      Strings.toLatinLowerCase(var10 = var7.substring(1)), MessageContext.messageContext());
                  if (var12 != null) {
                    builder.append(var12.buildPlain(new MessageContextImpl()));
                  } else {
        ...
        if (SIXTEEN) {
          ...
          for (var5 = 0; var5 < var2 - 1; ++var5) {
            if ((var6 = var0.charAt(var5)) == 167) {
              ...
              if (var4 != -1) {
                if (TextFormatCodes.isColorCode(var6)) {
                  if (var1) {
                    var8.append(var6);
                  }
                ...
                boolean var7;
                if ((var7 = var6 == 'x') || TextFormatCodes.isTextFormatCode(var6)) {
                  if (var1) {
                    var8.append('&');
                  }
          ...
          if (var1) {
            ...
            for (var4 = 0; var4 < var2 - 1; ++var4) {
              if (var3[var4] == 167 && TextFormatCodes.isTextFormatCode(var3[var4 + 1])) {
                var3[var4++] = '&';
              }
            }
            ...
            for (var5 = 0; var5 < var2 - 1; ++var5) {
              if ((var6 = var0.charAt(var5)) == 167 && TextFormatCodes.isTextFormatCode(var0.charAt(var5 + 1))) {
                ++var5;
              } else {
                var3[var4++] = var6;
              }
  ...
  public static void sendConsoleMessage(String var0) {
    sendMessage(Platform.get().getConsoleSender(), var0, false);
  }
