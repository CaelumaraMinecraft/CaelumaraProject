...
public enum StandardKingdomsPlaceholder implements EnumKingdomsPlaceholderTranslator {
  ...
  public static void init() {
    ...
    while (var2.hasNext()) {
      var3 = var2.next();
      TextContainer var6 = TextContainer.parse(
          AuspiceGlobalConfig.PLACEHOLDERS_VARIABLES.getManager().withProperty(var3));
      Objects.requireNonNull(var3);
  ...
  @Nullable
  public static TextObject getMacro(@NotNull String var1, @Nullable MessageContext var2) {
