...
public class ComplexTextBuilderContextProvider extends TextBuilderContextProvider {
  ...
  public static final @Unmodifiable Set<Merge> ALL_MERGES = Set.of(
      Merge.COLOR, Merge.SHADOW_COLOR, Merge.DECORATIONS, Merge.EVENTS, Merge.INSERTION, Merge.FONT);
  public static final @Unmodifiable Set<Merge> EXCEPT_COLOR_MERGES = Set.of(
      Merge.DECORATIONS, Merge.EVENTS, Merge.INSERTION, Merge.FONT);
  public static final @Unmodifiable Set<Merge> EXCEPT_DECORATIONS_MERGES = Set.of(
      Merge.COLOR, Merge.SHADOW_COLOR, Merge.EVENTS, Merge.INSERTION, Merge.FONT);
  public static final @Unmodifiable Set<Merge> FORMATTING_MERGES = Set.of(
      Merge.COLOR, Merge.SHADOW_COLOR, Merge.DECORATIONS, Merge.INSERTION, Merge.FONT);
