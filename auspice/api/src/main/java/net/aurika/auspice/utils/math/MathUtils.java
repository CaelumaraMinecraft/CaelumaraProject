...
public final class MathUtils {
    ...
    if (obj == null) {
      ...
      if (obj instanceof Number) {
        ...
        throw new IllegalArgumentException(
            "Expected an arithmetic placeholder for '" + var0 + "' instead got '" + obj + "' (" + obj.getClass().getName() + ')');
      }
    }
  }
  ...
  public static Double parseDouble(String str) {
    try {
      ...
      return !Double.isNaN(
          value) && value != Double.NEGATIVE_INFINITY && value != Double.POSITIVE_INFINITY ? value : null;
