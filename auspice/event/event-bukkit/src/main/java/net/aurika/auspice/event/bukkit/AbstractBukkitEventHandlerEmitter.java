...
public abstract class AbstractBukkitEventHandlerEmitter<E extends org.bukkit.event.Event & BukkitEvent> implements BukkitEventHandlerEmitter<E> {

  private final @NotNull LinkedList<Listener<E>> listeners;
  private final @NotNull HandlerList handlerList;

  public AbstractBukkitEventHandlerEmitter(@NotNull HandlerList handlerList) {
    this(new LinkedList<>(), handlerList);
  }

  public AbstractBukkitEventHandlerEmitter(@NotNull LinkedList<Listener<E>> listeners, @NotNull HandlerList handlerList) throws EventNotListenableException {
